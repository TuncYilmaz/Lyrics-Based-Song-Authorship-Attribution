...
y_train_POS = readPickle("cnn_data_inputs/POS_Keras/y_train_POS_reduced")
y_dev_POS = readPickle("cnn_data_inputs/POS_Keras/y_dev_POS_reduced")
y_test_POS = readPickle("cnn_data_inputs/POS_Keras/y_test_POS_reduced")
...
writePickle(predictions, "predictions_POS_reduced_batchnorm_25ep_64bch")
...
model.summary()
model.save("../Saved_Models/POS_reduced_25ep_64bch_05Drop_33filter_batchnorm")

writePickle(history,"history_POS_reduced_25ep_64bch_05Drop_33filter_batchnorm")
