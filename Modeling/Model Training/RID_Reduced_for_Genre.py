...
y_train_RID = readPickle("cnn_data_inputs/POS_Keras/y_train_genre")
y_dev_RID = readPickle("cnn_data_inputs/POS_Keras/y_dev_genre")
y_test_RID = readPickle("cnn_data_inputs/POS_Keras/y_test_genre")
...
writePickle(predictions, "predictions_RID_GENRE_reduced_batchnorm_25ep_64bch")
...
model.summary()
model.save("../Saved_Models/RID_GENRE_reduced_25ep_64bch_05Drop_11filter_batchnorm")

writePickle(history,"history_RID_GENRE_reduced_25ep_64bch_05Drop_11filter_batchnorm")
