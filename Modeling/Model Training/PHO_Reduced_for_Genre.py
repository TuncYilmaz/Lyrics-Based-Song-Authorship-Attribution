...
y_train_PHO1 = readPickle("cnn_data_inputs/POS_Keras/y_train_genre")
y_dev_PHO1 = readPickle("cnn_data_inputs/POS_Keras/y_dev_genre")
y_test_PHO1 = readPickle("cnn_data_inputs/POS_Keras/y_test_genre")
...
writePickle(predictions, "predictions_PHO_GENRE_10_10_batchnorm_25ep_64bch")
...
model.summary()
model.save("../Saved_Models/PHO_GENRE_10_10_25ep_64bch_05Drop_33filter_batchnorm")

writePickle(history,"history_PHO_GENRE_10_10_25ep_64bch_05Drop_33filter_batchnorm")
