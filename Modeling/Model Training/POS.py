...
history = model.fit(X_train_POS, y_train_POS, validation_data=(X_dev_POS, y_dev_POS), epochs=25, batch_size=128)
...
writePickle(predictions, "predictions_POS_25ep_128bch_05Drop_33filter_batchnorm")
...
model.summary()
model.save("../Saved_Models/POS_25ep_128bch_05Drop_33filter_batchnorm")

writePickle(history,"history_POS_25ep_128bch_05Drop_33filter_batchnorm")
