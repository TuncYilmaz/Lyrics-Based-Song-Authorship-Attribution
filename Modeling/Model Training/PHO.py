...
#import variables
X_train_PHO1 = readPickle("cnn_data_inputs/PHO1_Keras/X_train_PHO1")
X_dev_PHO1 = readPickle("cnn_data_inputs/PHO1_Keras/X_dev_PHO1")
X_test_PHO1 = readPickle("cnn_data_inputs/PHO1_Keras/X_test_PHO1")
y_train_PHO1 = readPickle("cnn_data_inputs/PHO1_Keras/y_train_PHO1")
y_dev_PHO1 = readPickle("cnn_data_inputs/PHO1_Keras/y_dev_PHO1")
y_test_PHO1 = readPickle("cnn_data_inputs/PHO1_Keras/y_test_PHO1")
max_line = 183
max_song = 100
...
model.fit(X_train_PHO1, y_train_PHO1, validation_data=(X_dev_PHO1, y_dev_PHO1), epochs=25, batch_size=128)
...
writePickle(predictions, "predictions_PHO1_25ep_128bch_025Drop_33filter_batchnorm")
...
model.summary()
model.save("../Saved_Models/PHO1_25ep_128bch_025Drop_33filter_batchnorm")

writePickle(history,"history_PHO1_25ep_128bch_025Drop_33filter_batchnorm")
